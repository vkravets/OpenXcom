...
OPT int oxceJoystickButtonRightClick;
OPT int oxceJoystickButtonKeyboard;
OPT int oxceJoystickButtonDelete;
// Structured options, serialized separately from scalar OptionInfo entries.
OPT std::vector<std::string> oxceVirtualKeyboardLanguages;
OPT std::map<std::string, VirtualKeyboardLayoutOptions> oxceVirtualKeyboardLayouts;
